...
class RequestResetPasswordAuthEvent extends AuthEvent {
  final String email;

  RequestResetPasswordAuthEvent({this.email});

  List<Object> get props => [toString()];

  @override
  String toString() {
    return 'ResetPasswordAuthEvent{}';
  }
}

class FinishResetPasswordAuthEvent extends AuthEvent {
  KeyAndPasswordVM keyAndPassword;

  FinishResetPasswordAuthEvent({this.keyAndPassword});
