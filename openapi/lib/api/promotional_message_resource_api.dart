...
class PromotionalMessageResourceApi {
    ...
    PromotionalMessageResourceApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<PromotionalMessage>>viewPromotionalMessageUsingGET(int id,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/promotional-messages/view/{id}".replaceAll("{" r'id' "}", id.toString());
        ...
        var serializer = _serializers.serializerForType(PromotionalMessage);
        var data = _serializers.deserializeWith<PromotionalMessage>(serializer, response.data is String ? jsonDecode(response.data) : response.data);

            return Response<PromotionalMessage>(
                data: data,
                headers: response.headers,
                request: response.request,
                redirects: response.redirects,
