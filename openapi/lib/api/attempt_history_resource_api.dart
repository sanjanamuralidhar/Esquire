...
class AttemptHistoryResourceApi {
    ...
    AttemptHistoryResourceApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<AttemptHistoryDTO>>createUserAttemptHistoryUsingPOST(String answers,AttemptHistoryDTO attemptHistoryDTO,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/attempt-histories/user-attempt/{answers}".replaceAll("{" r'answers' "}", answers.toString());
        ...
        ///
        /// 
        Future<Response<AttemptHistory>>getAttemptHistoryDetailsUsingGET(int id,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/attempt-histories/user-attempt/{id}".replaceAll("{" r'id' "}", id.toString());
        ...
        var serializer = _serializers.serializerForType(AttemptHistory);
        var data = _serializers.deserializeWith<AttemptHistory>(serializer, response.data is String ? jsonDecode(response.data) : response.data);

            return Response<AttemptHistory>(
                data: data,
                headers: response.headers,
                request: response.request,
                redirects: response.redirects,
        ...
        ///
        /// 
        Future<Response<List<AttemptHistoryDTO>>>getLoyaltyProgramUsingGET(int id,{ int page,int size,List<String> sort,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/attempt-histories/loyalty-programs/{id}".replaceAll("{" r'id' "}", id.toString());
        ...
        ///
        /// 
        Future<Response<List<AttemptHistoryDTO>>>getWinnersUsingGET(int promotionalMessageId,{ int page,int size,List<String> sort,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/attempt-histories/winners/{promotionalMessageId}".replaceAll("{" r'promotionalMessageId' "}", promotionalMessageId.toString());
