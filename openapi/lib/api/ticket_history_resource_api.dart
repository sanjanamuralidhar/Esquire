...
class TicketHistoryResourceApi {
    ...
    TicketHistoryResourceApi(this._dio, this._serializers);
        ...
        /// getTicketHistoriesByProductId
        ///
        /// 
        Future<Response<List<TicketHistoryDTO>>>getTicketHistoriesByProductIdUsingGET(int productId,{ int page,int size,List<String> sort,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/ticket-histories/products/{productId}".replaceAll("{" r'productId' "}", productId.toString());
