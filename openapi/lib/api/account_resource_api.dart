...
class AccountResourceApi {
    ...
    AccountResourceApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<User>>registerCustomerUsingPOST(ManagedUserVM managedUserVM,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/account/register/customer";
