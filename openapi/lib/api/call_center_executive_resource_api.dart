...
class CallCenterExecutiveResourceApi {
    ...
    CallCenterExecutiveResourceApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<CallCenterExecutive>>getAllCallCenterExecutivesByUserLoginUsingGET(String userLogin,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/call-center-executives/users/{userLogin}".replaceAll("{" r'userLogin' "}", userLogin.toString());
        ...
        var serializer = _serializers.serializerForType(CallCenterExecutive);
        var data = _serializers.deserializeWith<CallCenterExecutive>(serializer, response.data is String ? jsonDecode(response.data) : response.data);

            return Response<CallCenterExecutive>(
                data: data,
                headers: response.headers,
                request: response.request,
                redirects: response.redirects,
