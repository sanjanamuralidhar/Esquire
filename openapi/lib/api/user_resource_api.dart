...
class UserResourceApi {
  ...
  ///
  ///
  Future<Response<User>> createCustomerUsingPOST1(
    UserDTO userDTO, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/api/users/customer";
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<User>(serializer,
  ...
  ///
  ///
  Future<Response<User>> createUserUsingPOST(
    UserDTO userDTO, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
  ...
  ///
  ///
  Future<Response> deleteUserUsingDELETE(
    String login, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path =
        "/api/users/{login:^(?>[a-zA-Z0-9!\$&*+=?^_`{|}~.-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*)|(?>[_.@A-Za-z0-9-]+)\$}"
            .replaceAll("{" r'login' "}", login.toString());
  ...
  ///
  ///
  Future<Response<List<UserDTO>>> getAllUsersUsingGET({
    int page,
    int size,
    List<String> sort,
    CancelToken cancelToken,
    ...
    return _dio
      ...
      BuiltList<UserDTO> dataList = _serializers.deserialize(
          response.data is String ? jsonDecode(response.data) : response.data,
          specifiedType: type);
  ...
  ///
  ///
  Future<Response<List<String>>> getAuthoritiesUsingGET({
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
  ...
  ///
  ///
  Future<Response<UserDTO>> getUserUsingGET(
    String login, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<UserDTO>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
  ...
  ///
  ///
  Future<Response<User>> registerCustomerUsingPOST(
    ManagedUserVM managedUserVM, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/api/users/register/customer";
  ...
  ///
  ///
  Future<Response<UserDTO>> updateUserUsingPUT(
    UserDTO userDTO, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
