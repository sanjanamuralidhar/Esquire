...
part of 'aggregate_address.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<AggregateAddress> _$aggregateAddressSerializer =
    new _$AggregateAddressSerializer();

class _$AggregateAddressSerializer
    implements StructuredSerializer<AggregateAddress> {
  @override
  final Iterable<Type> types = const [AggregateAddress, _$AggregateAddress];
  @override
  final String wireName = 'AggregateAddress';

  @override
  Iterable<Object> serialize(Serializers serializers, AggregateAddress object,
  ...
  @override
  AggregateAddress deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new AggregateAddressBuilder();
...
class _$AggregateAddress extends AggregateAddress {
  @override
  final String city;
  @override
  ...
  factory _$AggregateAddress(
          [void Function(AggregateAddressBuilder) updates]) =>
      (new AggregateAddressBuilder()..update(updates)).build();

  _$AggregateAddress._(
      {this.city,
      this.customerName,
      this.district,
      this.geoLocation,
  ...
  @override
  AggregateAddress rebuild(void Function(AggregateAddressBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AggregateAddressBuilder toBuilder() =>
      new AggregateAddressBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AggregateAddress &&
        city == other.city &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AggregateAddress')
          ..add('city', city)
...
class AggregateAddressBuilder
    implements Builder<AggregateAddress, AggregateAddressBuilder> {
  _$AggregateAddress _$v;
  ...
  AggregateAddressBuilder();

  AggregateAddressBuilder get _$this {
    if (_$v != null) {
      _city = _$v.city;
  ...
  @override
  void replace(AggregateAddress other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$AggregateAddress;
  }

  @override
  void update(void Function(AggregateAddressBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$AggregateAddress build() {
    final _$result = _$v ??
        new _$AggregateAddress._(
            city: city,
